...
$strubikc        = get_string('modulenameplural', 'folder');
...
$PAGE->set_title($course->shortname.': '.$strubikc);
$PAGE->set_heading($course->fullname);
$PAGE->navbar->add($strubikc);
echo $OUTPUT->header();

if (!$ubikc = get_all_instances_in_course('folder', $course)) {
    notice(get_string('thereareno', 'moodle', $strubikc), "$CFG->wwwroot/course/view.php?id=$course->id");
    exit;
}
